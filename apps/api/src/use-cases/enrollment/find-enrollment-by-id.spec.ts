...
import { FindEnrollmentByIdUseCase } from './find-enrollment-by-id'

describe('FindEnrollmentByIdUseCase', () => {
  let enrollmentsRepository: InMemoryEnrollmentsRepository
  let usersRepository: InMemoryUsersRepository
  let coursesRepository: InMemoryCoursesRepository
  let sut: FindEnrollmentByIdUseCase
  ...
  beforeEach(() => {
    ...
    sut = new FindEnrollmentByIdUseCase(enrollmentsRepository)
  })
