...
import { FindProgressByIdUseCase } from './find-progress-by-id'

describe('FindProgressByIdUseCase', () => {
  ...
  let sut: FindProgressByIdUseCase
  ...
  beforeEach(() => {
    ...
    sut = new FindProgressByIdUseCase(progressesRepository)
  })

  it('should find a progress by id', async () => {
