...
import { FindProgressWithLessonUseCase } from './find-progress-with-lesson'

describe('FindProgressWithLessonUseCase', () => {
  ...
  let sut: FindProgressWithLessonUseCase
  ...
  beforeEach(() => {
    ...
    sut = new FindProgressWithLessonUseCase(progressesRepository)
  })

  it('should find a progress with lesson, module, and course', async () => {
    ...
    } as ProgressRelations['WithLesson']
