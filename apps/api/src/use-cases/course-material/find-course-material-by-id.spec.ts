...
import { FindCourseMaterialByIdUseCase } from './find-course-material-by-id'

describe('FindCourseMaterialByIdUseCase', () => {
  let courseMaterialsRepository: InMemoryCourseMaterialsRepository
  let coursesRepository: InMemoryCoursesRepository
  let usersRepository: InMemoryUsersRepository
  let sut: FindCourseMaterialByIdUseCase
  ...
  beforeEach(() => {
    ...
    sut = new FindCourseMaterialByIdUseCase(courseMaterialsRepository)
  })

  it('should find a course material by id', async () => {
