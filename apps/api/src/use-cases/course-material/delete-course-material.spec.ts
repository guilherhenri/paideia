...
import { DeleteCourseMaterialUseCase } from './delete-course-material'

describe('DeleteCourseMaterialUseCase', () => {
  let courseMaterialsRepository: InMemoryCourseMaterialsRepository
  let coursesRepository: InMemoryCoursesRepository
  let usersRepository: InMemoryUsersRepository
  let sut: DeleteCourseMaterialUseCase
  ...
  beforeEach(() => {
    ...
    sut = new DeleteCourseMaterialUseCase(courseMaterialsRepository)
  })

  it('should delete a course material', async () => {
    ...
    const deletedCourseMaterial = await courseMaterialsRepository.findById(
      courseMaterial.id,
    )
    expect(deletedCourseMaterial).toBeNull()
  })
