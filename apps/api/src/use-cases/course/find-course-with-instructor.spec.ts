...
import { FindCourseWithInstructorUseCase } from './find-course-with-instructor'

describe('FindCourseWithInstructorUseCase', () => {
  let coursesRepository: InMemoryCoursesRepository
  let usersRepository: InMemoryUsersRepository
  let sut: FindCourseWithInstructorUseCase

  beforeEach(() => {
    coursesRepository = new InMemoryCoursesRepository()
    usersRepository = new InMemoryUsersRepository()
    sut = new FindCourseWithInstructorUseCase(coursesRepository)
  })

  it('should find a course with instructor', async () => {
    ...
    coursesRepository.courses[0] = {
      ...course,
      instructor,
    } as CourseRelations['WithInstructor']
